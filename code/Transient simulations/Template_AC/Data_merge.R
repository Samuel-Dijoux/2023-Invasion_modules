...
########################################################################
Fw <-'AC'             # Food web nomenclature, invasion of resource B in Consumer C-resource A system
...
write.table(Invdata, 'AC_Pop.txt', dec= ".", sep = "\t", row.names=FALSE, col.names=TRUE)
