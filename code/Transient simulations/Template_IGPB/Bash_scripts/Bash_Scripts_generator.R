...
Fw <-'IGPB';           # Food web nomenclature, invasion of Intraguild-prey species
# Create a path directing where will be created all "BMRs" directory folders. Example: "./Template_IGPB";
Path <- "ZZ HERE ZZ";
