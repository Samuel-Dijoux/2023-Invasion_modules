...
########################################################################
Fw <-'IGPC'             # Food web nomenclature, invasion of predator C in Consumer B-resource A system
...
write.table(Invdata, 'IGPC_Pop.txt', dec= ".", sep = "\t", row.names=FALSE, col.names=TRUE)
