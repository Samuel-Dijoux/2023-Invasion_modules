...
## Visit the "Template_AC: folder to generate automatically all the scripts (R and Bash), 
...
Alpha = 1;            # Body mass ratio between resident and invading basal species
Beta = 1;             # Body mass ratio between invading basal species and consumer
