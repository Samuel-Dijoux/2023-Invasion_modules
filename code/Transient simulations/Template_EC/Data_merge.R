...
########################################################################
Fw <-'EC'             # Food web nomenclature, invasion of consumer B in Consumer C-resource A system
...
write.table(Invdata, 'EC_Pop.txt', dec= ".", sep = "\t", row.names=FALSE, col.names=TRUE)
